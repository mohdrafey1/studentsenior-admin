...
const SeniorList = () => {
    ...
    const filteredSeniors = seniors.filter(
        (senior) =>
            ...
            senior.email?.toLowerCase().includes(search.toLowerCase()) ||
            senior.phoneNumber?.includes(search) ||
            senior.branch?.toLowerCase().includes(search.toLowerCase()) ||
            senior.graduationYear?.toString().includes(search)
    );
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="relative flex-1 max-w-md">
                            ...
                            <input
                                type="text"
                                placeholder="Search seniors by name, email, branch..."
                                value={search}
                                onChange={(e) => {
