                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
                    ...
                    <div className='text-center py-12'>
                        ...
                        <p className='text-gray-500 dark:text-gray-400'>
                            {error || "The PYQ you're looking for doesn't exist."}
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <dl className='grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6'>
                                <div>
                                    ...
                                    <dd className='text-sm font-medium text-gray-900 dark:text-gray-100'>
                                        {pyq.subject?.subjectName || 'N/A'} ({pyq.subject?.subjectCode})
                                    </dd>
                                </div>
                                <div>
                                    <dt className='text-sm text-gray-500 dark:text-gray-400 font-medium mb-1'>
                                    ...
                                    <dd className='text-sm font-medium text-gray-900 dark:text-gray-100'>
                                        {pyq.subject?.branch?.branchName || 'N/A'}
                                    </dd>
                                </div>
                                <div>
                                    <dt className='text-sm text-gray-500 dark:text-gray-400 font-medium mb-1'>
                                    ...
                                    <dd className='text-sm font-medium text-gray-900 dark:text-gray-100'>
                                        {pyq.subject?.branch?.course?.courseName || 'N/A'}
                                    </dd>
                                </div>
                                <div>
                                    <dt className='text-sm text-gray-500 dark:text-gray-400 font-medium mb-1'>
                                    ...
                                    <dd className='text-sm font-medium text-gray-900 dark:text-gray-100'>
                                        Semester {pyq.subject?.semester || 'N/A'}
                                    </dd>
                                </div>
                            </dl>
                        </div>
                    ...
                    <div className='space-y-8'>
                        ...
                        <div className='bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6'>
                            ...
                            <dl className='space-y-4'>
                                ...
                                {pyq.rejectionReason && pyq.submissionStatus === 'rejected' && (
                                    <div>
                                        <dt className='text-sm text-gray-500 dark:text-gray-400 font-medium mb-1'>
                                            Rejection Reason
                                        </dt>
